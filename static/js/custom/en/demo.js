...
.then(responseData => {
    ...
    chartOption['seriesName'] = 'Temperature';
...
.then(responseData => {
    ...
    chartOption['seriesName'] = 'Voltage';
...
.then(responseData => {
    ...
    chartOption['seriesName'] = 'Max-Min Voltage Gap';
...
.then(responseData => {
    ...
    chartOption['seriesName'] = 'Max-Min Temperature Gap';
