...
async function createForecastingBankSoLChart() {
    ...
    let forecastingSoLSeries = chart.series.push(am5xy.SmoothedXLineSeries.new(root, {
        ...
        valueXField: 'date',
        tooltip: am5.Tooltip.new(root, {
            labelText: `[bold]{name}[/]\nTop Limit Forecasting: {topLimitValue}\nForecasting: {valueY}\nBottom Limit Forecasting: {bottomLimitValue}`,
        })
    }));

    let forecastingTopLimitSoLSeries = chart.series.push(am5xy.SmoothedXLineSeries.new(root, {
        name: 'Top Limit Forecasting SoL',
        xAxis: xAxis,
        yAxis: yAxis,
    ...
    let forecastingBottomLimitSoLSeries = chart.series.push(am5xy.SmoothedXLineSeries.new(root, {
        name: 'Bottom Limit Forecasting SoL',
        xAxis: xAxis,
        yAxis: yAxis,
...
function getMainEXSoSChartSeries(elementId, option) {
    ...
    let series = chart.series.push(am5xy.LineSeries.new(root, {
        ...
        valueYField: 'value',
        tooltip: am5.Tooltip.new(root, {
            labelText: `Integrated Safety: {valueY}`
        })
    }));
...
function changeDetailEXSoSChart(option) {
    ...
    detailEXSoSChartInfoElement.innerHTML = `<p>${DateTime.fromMillis(dataObject['time']).toFormat(customFullDateTimeFormat)} [Integrated Safety]: ${dataObject['value']}</p>`;
    ...
    let rangeDataOption = [
        {
            ...
            axisLabelText: 'Average Voltage'
        },
        {
            rangeDataItemValue: temperature,
            axisLabelText: 'Average Temperature'
        },
    ];

    switch (chargeStatus) {
        case 0:
            detailEXSoSSafetyStatusInfoElement.innerHTML = `<p>${time} [Charge Status]: ${voltage}V, ${temperature}&#8451</p>`
            ...
            break;
        case 1:
            detailEXSoSSafetyStatusInfoElement.innerHTML = `<p>${time} [Discharge Status]: ${voltage}V, ${temperature}&#8451</p>`
            ...
            break;
        case 2:
            detailEXSoSSafetyStatusInfoElement.innerHTML = `<p>${time} [Rest Status]: ${voltage}V, ${temperature}&#8451</p>`
            ...
            rangeDataOption.push({
                ...
                axisLabelText: 'Average Voltage Gap'
            });
            rangeDataOption.push({
                rangeDataItemValue: temperatureGap,
                axisLabelText: 'Average Temperature Gap'
            });
...
function createAvgChartLine(chartSeries, data) {
    ...
    avgAxisLabel.setAll({
        text: `Average ${avgAxisRange.get('value').toFixed(2)}`,
...
function getForecastingMaxMinRackCellSeriesList(elementId, option) {
    ...
    let seriesList = seriesInfo.map(element => {
        ...
        if (element['name'] == 'Observed') {
            tooltip = am5.Tooltip.new(root, {
                labelText: `Value: {valueY}, Battery Cell Number: {observedPosition}`,
...
essBankVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    essBankVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
...
essRackVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    essRackVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
    essRackVisualizationSearchModalFormRackSelectElement.innerHTML = '';
    essRackVisualizationSearchModalFormRackSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a rack.</option>');
...
essBankSoHVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    essBankSoHVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
...
essRackSoHVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    essRackSoHVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
    ...
    essRackSoHVisualizationSearchModalFormRackSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a rack.</option>');
...
essRackSoSVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    essRackSoSVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
    ...
    essRackSoSVisualizationSearchModalFormRackSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a rack.</option>');
...
essEXSoSVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', event => {
    ...
    essEXSoSVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
    ...
    essEXSoSVisualizationSearchModalFormRackSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a rack.</option>');
...
forecastingObjectVisualizationSearchModalFormOperatingSiteSelectElement.addEventListener('change', (event) => {
    ...
    forecastingObjectVisualizationSearchModalFormBankSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a bank.</option>');
    ...
    forecastingObjectVisualizationSearchModalFormRackSelectElement.insertAdjacentHTML('afterbegin', '<option value="" selected disabled>Select a rack.</option>');
...
detailExSoSSafetyOption['xAxisText'] = 'Voltage(V)';
...
detailExSoSSafetyOption['xAxisText'] = 'Temperature(&#8451;)';
...
let minRackCellVoltageSeries = voltageGapChart.series.push(am5xy.LineSeries.new(voltageGapChartRoot, {
    ...
    tooltip: am5.Tooltip.new(voltageGapChartRoot, {
        labelText: "Min Voltage Value : {valueY} V",
        pointerOrientation: "horizontal"
    })
}));
...
let maxRackCellVoltageSeries = voltageGapChart.series.push(am5xy.LineSeries.new(voltageGapChartRoot, {
    ...
    fill: am5.color("#0x00589b"),
    tooltip: am5.Tooltip.new(voltageGapChartRoot, {
        labelText: "Max Voltage Value : {valueY} V",
        pointerOrientation: "horizontal"
    })
}));
