    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rack_n001_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N001_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n002_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N002_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n003_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N003_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n004_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N004_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n005_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N005_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n006_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N006_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n007_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N007_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ('rack_n008_master_rack_communication_fault', models.IntegerField(blank=True, db_column='RACK_N008_MASTER_RACK_COMMUNICATION_FAULT', null=True)),
                ...
                ('master_rack_communication_fault', models.IntegerField(blank=True, db_column='MASTER_RACK_COMMUNICATION_FAULT', null=True)),
            ],
            options={
                'db_table': 'bank',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inv1_cumluative_power_generation', models.FloatField(blank=True, db_column='INV1_CUMLUATIVE_POWER_GENERATION', null=True)),
            ],
            options={
                'db_table': 'etc',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_temperature_max', models.FloatField(blank=True, db_column='SYSTEM_TEMPERATURE_MAX', null=True)),
                ...
                ('ac_accumulated_discharge_energy_low', models.FloatField(blank=True, db_column='AC_ACCUMULATED_DISCHARGE_ENERGY_LOW', null=True)),
                ('ac_accumulated_discharge_energy_high', models.FloatField(blank=True, db_column='AC_ACCUMULATED_DISCHARGE_ENERGY_HIGH', null=True)),
                ('ac_accumulated_charge_energy_low', models.FloatField(blank=True, db_column='AC_ACCUMULATED_CHARGE_ENERGY_LOW', null=True)),
                ('ac_accumulated_charge_energy_high', models.FloatField(blank=True, db_column='AC_ACCUMULATED_CHARGE_ENERGY_HIGH', null=True)),
                ...
                ('set_soc_low_trip_level', models.FloatField(blank=True, db_column='SET_SOC_LOW_TRIP_LEVEL', null=True)),
                ('set_soc_high_trip_level', models.FloatField(blank=True, db_column='SET_SOC_HIGH_TRIP_LEVEL', null=True)),
                ('set_vbat_low_trip_level', models.FloatField(blank=True, db_column='SET_VBAT_LOW_TRIP_LEVEL', null=True)),
                ('set_vbat_high_trip_level', models.FloatField(blank=True, db_column='SET_VBAT_HIGH_TRIP_LEVEL', null=True)),
            ],
            options={
                'db_table': 'pcs',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rack_cell_temperature_average', models.FloatField(blank=True, db_column='RACK_CELL_TEMPERATURE_AVERAGE', null=True)),
                ...
                ('rack_rack_temperature_imbalance_warning', models.IntegerField(blank=True, db_column='RACK_RACK_TEMPERATURE_IMBALANCE_WARNING', null=True)),
                ('rack_rack_under_temperature_warning', models.IntegerField(blank=True, db_column='RACK_RACK_UNDER_TEMPERATURE_WARNING', null=True)),
                ('rack_rack_over_temperature_warning', models.IntegerField(blank=True, db_column='RACK_RACK_OVER_TEMPERATURE_WARNING', null=True)),
                ('rack_rack_voltage_imbalance_warning', models.IntegerField(blank=True, db_column='RACK_RACK_VOLTAGE_IMBALANCE_WARNING', null=True)),
                ('rack_rack_under_voltage_protection_warning', models.IntegerField(blank=True, db_column='RACK_RACK_UNDER_VOLTAGE_PROTECTION_WARNING', null=True)),
                ('rack_rack_over_voltage_protection_warning', models.IntegerField(blank=True, db_column='RACK_RACK_OVER_VOLTAGE_PROTECTION_WARNING', null=True)),
                ('rack_over_current_charge_warning', models.IntegerField(blank=True, db_column='RACK_OVER_CURRENT_CHARGE_WARNING', null=True)),
                ('rack_over_current_discharge_warning', models.IntegerField(blank=True, db_column='RACK_OVER_CURRENT_DISCHARGE_WARNING', null=True)),
                ('rack_rack_temperature_imbalance_fault', models.IntegerField(blank=True, db_column='RACK_RACK_TEMPERATURE_IMBALANCE_FAULT', null=True)),
                ('rack_rack_under_temperature_fault', models.IntegerField(blank=True, db_column='RACK_RACK_UNDER_TEMPERATURE_FAULT', null=True)),
                ('rack_rack_over_temperature_fault', models.IntegerField(blank=True, db_column='RACK_RACK_OVER_TEMPERATURE_FAULT', null=True)),
                ('rack_rack_voltage_imbalance_fault', models.IntegerField(blank=True, db_column='RACK_RACK_VOLTAGE_IMBALANCE_FAULT', null=True)),
                ('rack_rack_under_voltage_protection_fault', models.IntegerField(blank=True, db_column='RACK_RACK_UNDER_VOLTAGE_PROTECTION_FAULT', null=True)),
                ('rack_rack_over_voltage_protection_fault', models.IntegerField(blank=True, db_column='RACK_RACK_OVER_VOLTAGE_PROTECTION_FAULT', null=True)),
                ('rack_over_current_charge_fault', models.IntegerField(blank=True, db_column='RACK_OVER_CURRENT_CHARGE_FAULT', null=True)),
                ('rack_over_current_discharge_fault', models.IntegerField(blank=True, db_column='RACK_OVER_CURRENT_DISCHARGE_FAULT', null=True)),
                ('rack_charge_relay_plus_fault_status', models.IntegerField(blank=True, db_column='RACK_CHARGE_RELAY_PLUS_FAULT_STATUS', null=True)),
                ('rack_discharge_relay_minus_fault_status', models.IntegerField(blank=True, db_column='RACK_DISCHARGE_RELAY_MINUS_FAULT_STATUS', null=True)),
